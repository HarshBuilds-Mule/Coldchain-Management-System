...
<aside class="sidenav" class:open={isOpen}>
	...
	<nav class="nav-links">
		<ul>
			...
			<li><button on:click={() => navigate('/Settings')}>Settings</button></li>
	...
	<div class="nav-footer">
		<button class="btn" on:click={() => navigate('/Login')}>Sign In</button>
		<button class="btn" on:click={() => navigate('/SignUp')}>Sign Up</button>
	</div>
</aside>
